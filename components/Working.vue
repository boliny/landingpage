<template>
  <div class="working p-10">
    <div class="container">
      <h1 class="text-center text-4xl font-bold text-white">
        فوائد العمل معنا
      </h1>
      <div class="cards grid lg:grid-cols-4 md:grid-cols-2 gap-10 py-5 my-10">
        <div
          class="item-card rounded-md bg-white p-10 text-center justify-items-center"
        >
          <div class="card-img">
            <svg
              width="215"
            ...
            >
              ...
              <g>
                <g>
                  <g>
                    <path
                      d="M437.019,74.981C388.668,26.629,324.38,0,256,0S123.332,26.629,74.981,74.981C26.629,123.332,0,187.62,0,256
				...
				l11.188,10.301C487.986,381.983,512,320.421,512,256C512,187.62,485.371,123.332,437.019,74.981z"
                    />
                    <path
                      d="M282.819,263.604h63.415v-15.208h-63.415c-1.619-5.701-5.007-10.662-9.536-14.25l35.913-86.701l-14.049-5.82
				...
				c6.989,0,12.673,5.685,12.673,12.673c0,6.989-5.685,12.673-12.673,12.673C249.011,268.673,243.327,262.989,243.327,256z"
                    />
                    <path
                      d="M451.168,256c0-107.616-87.552-195.168-195.168-195.168S60.832,148.384,60.832,256S148.384,451.168,256,451.168
				...
				S355.231,435.96,256,435.96S76.04,355.231,76.04,256z"
                    ...
                    />
                    <path
                      d="M61.672,336.501l-14.05,5.82c23.059,55.668,66.416,99.026,122.085,122.085l5.82-14.049
				C123.61,428.851,83.176,388.416,61.672,336.501z"
                    />
                    <path
                      d="M450.397,175.485l14.049-5.82c-23.059-55.669-66.417-99.027-122.085-122.084l-5.82,14.049
				C388.457,83.135,428.891,123.569,450.397,175.485z"
                    />
                    <path
                      d="M256,45.624V30.416c-60.256,0-116.904,23.465-159.512,66.071C53.881,139.095,30.416,195.744,30.416,256h15.208
				c0-56.194,21.883-109.024,61.617-148.759C146.976,67.507,199.807,45.624,256,45.624z"
                    />
                    <path
                      d="M481.584,256h-15.208c0,56.193-21.883,109.024-61.617,148.759c-39.734,39.735-92.566,61.617-148.759,61.617v15.208
          ...
          <div class="card-body">
            <h3 class="font-bold my-5 text-gradient">استراتيجيات النمو</h3>
            <p>
              : مساعدة الشركات على وضع خطط نمو فعالة بناءً على تحليل بيانات
              السوق والاتجاهات
            </p>
          </div>
        </div>
      ...
      <div class="text-center">
        <button class="btn-white lg:w-1/5 md:w-full">تواصل معنا</button>
      </div>
    </div>
  </div>
</template>
